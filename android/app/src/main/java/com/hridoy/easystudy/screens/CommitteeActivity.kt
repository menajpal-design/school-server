...
class CommitteeActivity : AppCompatActivity() {
    ...
    private fun loadCommittee() {
        progressBar.visibility = View.VISIBLE
        RetrofitClient.api.getCommittee().enqueue(object : Callback<JsonObject> {
            override fun onResponse(call: Call<JsonObject>, response: Response<JsonObject>) {
                ...
                if (response.isSuccessful && response.body() != null) {
                    ...
                    if (items.isEmpty()) items.add(SimpleItem("Committee", "No committee members"))
            ...
            override fun onFailure(call: Call<JsonObject>, t: Throwable) {
                progressBar.visibility = View.GONE
                Toast.makeText(this@CommitteeActivity, "Error: ${t.message}", Toast.LENGTH_SHORT).show()
            }
        })
    }
}
