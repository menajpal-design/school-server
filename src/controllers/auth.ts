    ...
    if (!institutionId) {
      ...
      institution = await Institution.create({
        ...
        billing: {
          ...
          attendanceSmsMode: (selected.plan as any).attendanceSmsMode || 'none',
          attendanceSmsMonthlyRatePerStudent: Number((selected.plan as any).attendanceSmsMonthlyRatePerStudent || 0),
          attendanceSmsMonthlyAmount: Number((selected.plan as any).attendanceSmsMonthlyAmount || 0),
