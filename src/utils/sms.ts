...
export const sendMonthlyParentSummarySMS = async (phone: string, studentName: string, summary: string, institutionId?: any) => sendSMS({ to: phone, message: summary, institutionId, recipientType: 'guardian', type: 'monthly_parent', purpose: 'monthly_parent_summary' });
